  ...
  return (
    <div className="bg-neutral-950">
      ...
      <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center p-8">
        ...
        <p className="mb-6 mt-4 max-w-3xl text-center text-lg font-light text-gray-200 md:text-xl">
            A platform for creators to collaborate and create amazing things
            together.
        </p>
